...
@dag(
    dag_id='Automatic_training_pet',
    description='Pipeline de entrenamiento automatico de modelos para prediccion de produccion de petroleo',
    start_date=datetime(2026, 5, 1),
    schedule="5 0 2 * *",
    is_paused_upon_creation=True,
    params={
        "experiment_name": "Experimento_pet_auto",
        "fecha_data": "Ultima(Default)",
        "decision_metric": "mse",
        "decision_logic": "ASC"
    }
)
def Automatic_training_pet():
    @task
    def get_experiments():
